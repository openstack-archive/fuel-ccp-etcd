...
if __name__ == "__main__":
    ...
    parser.add_argument('--sleep-min', type=int, default=2,
                        help='Minimum sleep before joining etcd')
    parser.add_argument('--sleep-max', type=int, default=10,
                        help='Maximum sleep before joining etcd')
